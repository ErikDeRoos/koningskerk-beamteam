...
namespace Generator.Tests
{
    public class LiturgieDatabaseTests
    {
        ...
        public class ZoekOnderdeelMethod : LiturgieDatabaseTests
        {
            ...
            {
                var engine = new EngineManagerBuilder()
        ...
        private static IEngineManager<T> FakeEngineManager<T>(IEngine<T> defaultEngine) where T : class, DbSetSettings, new()
        {
        ...
        private static IEngineManager<T> FakeEngineManagerExtension<T>(string name, IEngine<T> engine) where T : class, DbSetSettings, new()
        {
            var manager = A.Fake<IEngineManager<T>>();
            var defaultReturn = A.Fake<IEngineSelection<T>>();
