...
namespace PowerpointGenerator.Genereren
{
    ...
    public class GeneratieInterface<T> : IDisposable where T : class, ICompRegistration
    {
        ...
        public GeneratieInterface(ILiturgieSlideMaker liturgieSlideMaker, IInstellingenFactory instellingenOplosser, ILiturgieTekstNaarObject liturgieTekstNaarObject, Func<IBuilder> builderResolver, ICompRegistration newCompRegistration)
        {
