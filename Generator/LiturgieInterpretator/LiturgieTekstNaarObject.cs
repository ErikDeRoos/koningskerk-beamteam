...
namespace Generator.LiturgieInterpretator
{
    ...
    /// </summary>
    public class LiturgieTekstNaarObject : ILiturgieTekstNaarObject
    {
        ...
        public ILiturgieTekstObject VanTekstregel(string regels)
        {
        ...
        /// </summary>
        public IEnumerable<ILiturgieTekstObject> VanTekstregels(string[] regels)
        {
            return regels
        ...
        private class InterpretatieNormaal : ILiturgieTekstObject
        {
